...
namespace TheSleepyKoala.Map
{
    ...
    new Tuple<int, string, int>(2, "Recovery Scroll", 1),
    new Tuple<int, string, int>(2, "Leather Armor", 15),
    ...
    new Tuple<int, string, int>(7, "Troll", 60),
        ...
        private bool SetWallTileIfEmpty(Vector3Int pos)
        {
            ...
            {
                MapManager.instance.ObstacleMap.SetTile(pos, MapManager.instance.WallTile[UnityEngine.Random.Range(0, MapManager.instance.WallTile.Length)]);
                return false;
            }
        }
        ...
        private void SetFloorTile(Vector3Int pos)
        {
            ...
            MapManager.instance.FloorMap.SetTile(pos, MapManager.instance.FloorTile[UnityEngine.Random.Range(0, MapManager.instance.FloorTile.Length)]);
        }
